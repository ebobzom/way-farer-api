...
con.query("CREATE TABLE trip(id integer primary key not null, destination varchar, origin varchar, bus_id integer, fare float, status varchar constraint DF_name default 'active', trip_date date, user_id integer)");
